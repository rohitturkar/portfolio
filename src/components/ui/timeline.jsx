        ...
        {data.map((item, index) => (
          <div key={index} className="flex justify-start pt-10 md:pt-10 md:gap-10">
            <div
              ...
              <h3
                className="hidden md:block text-2xl w-full  md:text-2xl lg:text-3xl font-bold text-purple-50 dark:text-neutral-500 ">
                {item.title}
              </h3>
              <div className='flex justify-start items-center gap-2 text-xs mt-4'>
              <p className='text-white text-xs border border-blue-200 p-2 rounded-lg cursor-pointer'>
                Source code
              </p>
              <p className='text-blue-300 text-xs  cursor-pointer'>
                live preview
              </p>
                </div>
            ...
            <div className="relative pl-16 pr-4 md:pl-2 w-full">
              <h3
                className="md:hidden block text-2xl mb-4 w-full text-left font-bold text-neutral-500 dark:text-neutral-500">
                {item.title}
              </h3>
